...
<template>
    <el-drawer v-model="isSideMenuOpen" direction="ltr" :with-header="false" size="300">
    ...
    <nav class="navbar top_navbar justify-content-end px-3 px-sm-5 gap-3">
        <div class="d-flex d-sm-none me-auto align-items-center">
            <div class="hamburger d-flex flex-column justify-content-between" @click="mobileSideMenuToggle">
                <span></span><span></span><span></span>
            </div>
            <div class="route_title ms-3">{{ navTitle }}</div>
        </div>
        <div class="topnav_plan d-none d-sm-block d-lg-none" v-if="store.state.user.isPremium">
            premium
        </div>
        ...
        <el-popover trigger="hover" placement="bottom">
            ...
            <el-menu :default-active="$i18n.locale">
