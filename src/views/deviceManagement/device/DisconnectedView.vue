...
const url = computed(()=>store.state.scrollBatchLoad.disconnectUrl)
...
async function getFilterAPI(params){
    let url = `${prefixURL}/data/devices/disconnected.json`
    try {
...
<template>
    ...
    tableName="disconnected" :filterOptions="filterOptions" :columnsExcept="columnsExcept" activeTab="disconnected"
